    ...
    if ((console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart)) {
        ...
        if ($("#canvasDoughnut").length) {
            ...
            var a = {
                ...
                datasets: [{ data: [120, 50, 140, 180, 100], backgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"], hoverBackgroundColor: ["#34495E", "#B370CF", "#CFD4D8", "#36CAAB", "#49A9EA"] }],
            };
        ...
        if ($("#pieChart").length)
            (e = document.getElementById("pieChart")),
                (a = { datasets: [{ data: [120, 50, 140, 180, 100], backgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"], label: "My dataset" }], labels: ["Dark Gray", "Purple", "Gray", "Green", "Blue"] }),
